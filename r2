...
xkb_symbols "r2" {
    ...
    key <AC05>	{[   Cyrillic_shorti,   Cyrillic_SHORTI  ]};
    key <AC06>	{[       Cyrillic_ka,       Cyrillic_KA  ]};
    key <AC07>	{[      Cyrillic_ghe,      Cyrillic_GHE  ]};
    ...
    key <AB03>	{[       Cyrillic_ie,       Cyrillic_IE  ]};
    key <AB04>	{[       Cyrillic_em,       Cyrillic_EM  ]};
    key <AB05>	{[       Cyrillic_ve,       Cyrillic_VE  ]};
    key <AB06>	{[       Cyrillic_es,       Cyrillic_ES  ]};
    key <AB07>	{[       Cyrillic_de,       Cyrillic_DE  ]};
